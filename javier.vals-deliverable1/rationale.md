...
Tool Used: Grobid, provideed by the teachers (https://github.com/kermitt2/grobid)

Grobid was used to extract structured information from 10 open-access papers in PDF format, wich have been taken fro the open
web site ArVix.org
...
First, I initially had issues extracting abstracts due to varying XML structures. I was dowloading the XML files with the
Full Header option and not Full Text.
...
Validation: I printed the full <abstract> content before processing it with other python script (extract_abstract_data.py), confirming that the correct text was extracted.
